...
def make_project_dir(path:str):
    ...
    nome_progetto: str      = get_key_value_JSON("project_settings.json", "nome_progetto")
    prefisso_cartella: str  = get_key_value_JSON("project_settings.json", "prefisso_cartella")
    cartella_bin: str       = get_key_value_JSON("project_settings.json", "cartella_bin")
    cartella_doc: str       = get_key_value_JSON("project_settings.json", "cartella_doc")
    cartella_file: str      = get_key_value_JSON("project_settings.json", "cartella_file")
...
def create_project_file(per_bin, per_doc):
    nome_progetto = get_key_value_JSON("project_settings.json", "nome_progetto")
    nome_readme = get_key_value_JSON("project_settings.json", "nome_readme")
    linguaggi_selezionati = get_key_value_JSON("project_settings.json", "linguaggi_selezionati")
    supported_leguages: dict = get_key_value_JSON("config.json", "supported_leguages")
