...
public class Eserc {
  ...
  /**
   * Legge un file di testo, restituisce il contenuto come vettore di stringhe linea per linea
   *
  ...
  public static String[] fileToString(String fileIn) {
    ...
    try {
      ...
      return (String[]) br.lines().toArray(String[]::new);
  ...
  /**
   * Nel vettore di stringhe restituisce la posizione del valore minore (in modo lessicografico) se
   * il vettore è vuoto la funzione restituisce -1
   *
   ...
   * @return true se tutti gli elementi del vettore sono dversi fra di loro false altrimenti, se il
   *     vettore è vuoto il metodo restituisce true
   */
  ...
  /**
   * Conta il numero di righe che contengono un certo pattern il pattern può essere in qualsiasi
   * posizione
   *
   * @param v
   * @param str
